        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
                ...
                if (FileUpload1.HasFile)
                {
                    ...
                    try
                    {
                        ...
                        string Task_name, image ,Task_batch , Task_User ,Task_date;
                        ...
                        Task_date = DateTime.Now.ToString("dd-MM-yyyy");

                        string q1 = $"exec  Task_assign '{Task_name}','{image}','{Task_batch}','{Task_User}','{Task_date}'  ";
